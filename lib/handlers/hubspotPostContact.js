    ...
    if (
      ...
      const contactObj = {
        properties: {
          ...
          company_orgid: contactData.company_orgid,
        },
      };
              ...
              filters: [
                {
                  ...
                  operator: "EQ",
                  value: contactData.company_orgid,
                },
              ],
            },
          ],
      ...
      return {
        ...
        body: JSON.stringify({
          message:
            "Invalid request. Ensure your request contains the following properties: 'firstname', 'lastname', 'email', 'company_orgid'",
        }),
      };
    }
  } catch (error) {
